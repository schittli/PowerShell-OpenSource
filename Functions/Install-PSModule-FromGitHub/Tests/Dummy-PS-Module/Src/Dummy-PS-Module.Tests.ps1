...
Describe $moduleName {
    ...
    InModuleScope $moduleName {
        ...
        Context 'Validates "Install-Dummy-PS-Module" method' {
            ...
            It 'Returns a "System.IO.DirectoryInfo" object type' {
                ...
                $directoryInfo = Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath;
            ...
            It 'Calls "ExpandZipArchive" with "OverrideRepository" when specified' {
                ...
                Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath -OverrideRepository $testOverrideRepository;
            ...
            It 'Calls "ExpandZipArchive" with "Force" when specified' {
                ...
                Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath -Force;
            ...
            It 'Calls "ExpandZipArchive" with "Clean" when specified' {
                ...
                Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath -Clean;
            ...
            It 'Calls "Invoke-WebRequest" with "/archive/master.zip" by default' {
                ...
                Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath;
            ...
            It 'Calls "Invoke-WebRequest" with "/archive/dev.zip" when "Branch" is specified' {
                ...
                Install-Dummy-PS-Module -Owner $testOwner -Repository $testRepository -DestinationPath $testDestinationPath -Branch $testBranch;

                Assert-MockCalled Invoke-WebRequest -ParameterFilter { $Uri -match "/archive/$testBranch.zip$" } -Scope It;
            }

        } #end context Validates "Install-Dummy-PS-Module" method
