...
function Install-Dummy-PS-Module {
<#
    .SYNOPSIS
        Downloads, extracts and installs a repository directly from GitHub.
    .DESCRIPTION
        The Install-Dummy-PS-Module cmdlet will download and extract a GitHub repository. This will typically be development PowerShell modules or DSC resources.
        
        Install-Dummy-PS-Module is primary intended to help bootstrap the installation of Powershell modules and DSC resources that have not (yet) been published to the PowerShell Gallery or have been updated on a development branch and are needed for testing purposes.
    .PARAMETER Owner
...
} #end function Install-Dummy-PS-Module
